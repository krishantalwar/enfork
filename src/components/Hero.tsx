...
const Hero = () => {
  return (
    <section
      className="container relative min-h-[100vh] overflow-hidden pt-28 r   bg-cover bg-center bg-no-repeat"
    ...
    >
      ...
      <div className="relative z-10  grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-medium text-foreground mb-6 leading-[1.3] tracking-wide">
            Powering Excellence
            <br />
